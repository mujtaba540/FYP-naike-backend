...
-- Started on 2021-09-22 16:05:45
...
-- Dependencies: 206
-- Data for Name: Address; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."Address" ("addressID", "userID", home, city, region, country) FROM stdin;
\.
...
-- Dependencies: 208
-- Data for Name: Categories; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."Categories" ("categoryID", name, "isActive", "isDelete", "createdOn", "createdBy", "modifiedOn", "modifiedBy", "deletedOn", "deletedBy") FROM stdin;
...
-- Dependencies: 212
-- Data for Name: Donation; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."Donation" ("donationID", "userID", "subCategoryID", description, status, "isActive", "isDelete", "createdBy", "createdOn", "modifiedOn", "modifiedBy", "deletedBy", "deletedOn", longitude, latitude, "deliveryType", "initialQuantity", "currentQuantity", title) FROM stdin;
...
-- Dependencies: 214
-- Data for Name: Need; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."Need" ("needID", "userID", "subCategoryID", "donationID", description, deadline, status, "needCount", "resolveCount", "isActive", "isDelete", "createdOn", "createdBy", "modifiedOn", "modifiedBy", "deletedOn", "deletedBy", longitude, latitude, "deliveryType", "initialQuantity", "currentQuantity", title) FROM stdin;
...
67	94	1	\N	hello\n	2021-09-30 00:00:00+05	active	1	0	f	f	2021-09-22	demoUser	2021-09-22	demoUser	2021-09-22	demoUser	74.36908153129579	31.433212238678117	Pick Up and Drop Off	12	12	dsdds
\.
...
-- Dependencies: 223
-- Data for Name: NeedResolver; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."NeedResolver" ("needResolverID", "resolverID", "needID", "currentQuantity", "validationStatus", "cancelationStatus") FROM stdin;
\.
...
-- Dependencies: 216
-- Data for Name: Privilege; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."Privilege" ("privilegeID", "menuName", "isActive", "isDelete", "subMenuName") FROM stdin;
...
-- Dependencies: 221
-- Data for Name: Reports; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."Reports" ("reportsID", "needID", "userID", description) FROM stdin;
\.
...
-- Dependencies: 202
-- Data for Name: Role; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."Role" ("roleID", "roleName", "isActive", "isDelete") FROM stdin;
10	user	t	\N
\.
...
-- Dependencies: 210
-- Data for Name: SubCategories; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."SubCategories" ("subCategoryID", "categoryID", name, "isActive", "isDelete", unit, "maxLimit", "createdOn", "createdBy", "modifiedOn", "modifiedBy", "deletedOn", "deletedBy") FROM stdin;
...
-- Dependencies: 204
-- Data for Name: UserDetails; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."UserDetails" ("userID", "roleID", "firstName", "lastName", email, password, phone, gender, "profileDP", "createdOn", "modifiedOn", "dateOfBirth", "isActive", "isDelete", "emailChecked", "phoneChecked", "createdBy", "modifiedBy", "deletedOn", "deletedBy") FROM stdin;
...
-- Dependencies: 218
-- Data for Name: rolePrevilege; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."rolePrevilege" ("privilegeID", "roleID", "rolePrivilegeID", add, view, edit, "isActive") FROM stdin;
7	10	4	f	t	t	t
8	10	5	t	t	t	t
9	10	6	t	t	t	t
10	10	7	f	t	f	t
...
-- Dependencies: 219
-- Data for Name: subCategoryHolder; Type: TABLE DATA; Schema: NaikE; Owner: postgres
--

COPY "NaikE"."subCategoryHolder" ("subCategoryID", "needID", "donationID") FROM stdin;
\.
...
-- Dependencies: 205
-- Name: Address_addressID_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."Address_addressID_seq"', 10, true);


--
-- TOC entry 3147 (class 0 OID 0)
-- Dependencies: 207
-- Name: Categories_categoryID_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."Categories_categoryID_seq"', 4, true);


--
-- TOC entry 3148 (class 0 OID 0)
-- Dependencies: 211
-- Name: Donation_Id_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."Donation_Id_seq"', 26, true);


--
-- TOC entry 3149 (class 0 OID 0)
-- Dependencies: 222
-- Name: NeedResolver_Id_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."NeedResolver_Id_seq"', 1, false);


--
-- TOC entry 3150 (class 0 OID 0)
-- Dependencies: 213
-- Name: Need_Id_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."Need_Id_seq"', 67, true);


--
-- TOC entry 3151 (class 0 OID 0)
-- Dependencies: 215
-- Name: Privilege_Id_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."Privilege_Id_seq"', 11, true);


--
-- TOC entry 3152 (class 0 OID 0)
-- Dependencies: 220
-- Name: Reports_Id_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."Reports_Id_seq"', 1, false);


--
-- TOC entry 3153 (class 0 OID 0)
-- Dependencies: 201
-- Name: Roles_roleID_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."Roles_roleID_seq"', 10, true);


--
-- TOC entry 3154 (class 0 OID 0)
-- Dependencies: 209
-- Name: SubCategories_subID_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."SubCategories_subID_seq"', 3, true);


--
-- TOC entry 3155 (class 0 OID 0)
-- Dependencies: 203
-- Name: UserDetails_id_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."UserDetails_id_seq"', 104, true);


--
-- TOC entry 3156 (class 0 OID 0)
-- Dependencies: 217
-- Name: rolePrevilege_Id_seq; Type: SEQUENCE SET; Schema: NaikE; Owner: postgres
--

SELECT pg_catalog.setval('"NaikE"."rolePrevilege_Id_seq"', 8, true);


-- Completed on 2021-09-22 16:05:46
